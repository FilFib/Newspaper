...
class UserSerializer(serializers.ModelSerializer):
    ...
    #articles = serializers.StringRelatedField(many=True) # diffrent options 
    ...
    def create(self, validated_data): #request_data
        ...
        except ValidationError as e: #error from django
            raise exceptions.ValidationError({'password': e.messages}) #error from rest_framework
        else:
            if email:
